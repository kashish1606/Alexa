...
def user_commands():
    command = ""  # Initialize command to an empty string to avoid UnboundLocalError
    try:
        ...
        print("Error:", e)  # Print error message for debugging
    return command  # Always return a valid string (empty if no command)
